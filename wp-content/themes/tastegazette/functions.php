<?php
/**
 * tastegazette functions and definitions
 *
...
if ( ! function_exists( 'tastegazette_setup' ) ) :
	 ...
	 */
	function tastegazette_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on tastegazette, use a find and replace
		 * to change 'tastegazette' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'tastegazette', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'tastegazette_custom_background_args', array(
...
add_action( 'after_setup_theme', 'tastegazette_setup' );
 ...
 */
function tastegazette_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'tastegazette_content_width', 640 );
}
add_action( 'after_setup_theme', 'tastegazette_content_width', 0 );
 ...
 */
function tastegazette_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'tastegazette' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'tastegazette' ),
...
add_action( 'widgets_init', 'tastegazette_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function tastegazette_scripts() {
	wp_enqueue_style( 'tastegazette-style', get_stylesheet_uri() );

	wp_enqueue_script( 'tastegazette-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
...
add_action( 'wp_enqueue_scripts', 'tastegazette_scripts' );
